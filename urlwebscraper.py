...
def extract_links(soup):
    ...
    keywords = [
        'roads', 'parks', 'permits', 'recreation', 'park', 'permit', 'road', 'waste management', 'social services',
        ...
        'housing-policy', 'residential-zoning', 'urban-planning', 'building-code', 'housing-ordinance', 
        'dwelling-regulation', 'residential-development', 'property-code', 'construction-regulation', 
        'duplex', 'triplex', 'fourplex', 'multifamily', 'single-family', 'co-housing', 'micro-apartment', 
        'modular-home', 'prefab-home', 'row-house', 'terrace-house', 'zoning-variance', 'occupancy-permit', 
        'building-inspection', 'code-enforcement', 'compliance-certification', 'affordable-housing-program', 
        'housing-subsidy', 'tax-incentive', 'housing-grant', 'low-income-housing', 'housing-voucher', 
        'green-building', 'energy-efficient-home', 'sustainable-housing', 'passive-house', 'net-zero-home', 
        'smart-home', 'eco-friendly-housing', 'social-housing', 'public-housing', 'community-land-trust', 
        'cooperative-housing', 'supportive-housing', 'transitional-housing', 'emergency-shelter', 
...
with open('london_aspx_links.csv', mode='w', newline='', encoding='utf-8') as file:
...
with open('london_pdf_links.csv', mode='w', newline='', encoding='utf-8') as file:
    writer = csv.writer(file)
    writer.writerow(["Title", "Link"])
    for link in all_pdf_links:
        writer.writerow(link)

print("Collected .aspx and .pdf links from 'https://london.ca/' have been saved to CSV files.")